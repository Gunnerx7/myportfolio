...
export const EXPERIENCES = [
  {
    ...
    company: "Waakan Technologies",
    description: `Worked in a team and assisted in developing and maintaining web applications using Java, React.js, and Spring Boot. Implemented RESTful APIs and integrated with Mysql databases. Collaborated with stakeholders to define project requirements and timelines.`,
